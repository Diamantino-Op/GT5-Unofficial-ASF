...
public class Textures {
    ...
    public enum BlockIcons implements IIconContainer, Runnable {
        ...
        NANITE_ACCELERATOR_PIPE_COIL,
        NANITE_ACCELERATOR_PIPE_CASING,
        NANITE_ACCELERATOR_PIPE_DIRECTOR,
        ATOMIC_RESISTANT_CASING,

        OVERLAY_FRONT_ASF,
        OVERLAY_FRONT_ASF_ACTIVE,
        OVERLAY_FRONT_ASF_ACTIVE_GLOW,
        OVERLAY_FRONT_ASF_GLOW,

        OVERLAY_HATCH_SWARM_CONDUCTIVITY_SENSOR,
        OVERLAY_HATCH_SWARM_CONDUCTIVITY_SENSOR_GLOW,
