...
public class LoaderMetaTileEntities implements Runnable { // TODO CHECK CIRCUIT RECIPES AND USAGES
    ...
    private static void registerMultiblockControllers() {
        ...
        ItemList.Machine_Multi_Atomic_Separation_Facility.set(
            new MTEAtomicSeparationFacility(AtomicSeparationFacility.ID, "multimachine.atomic-separation-facility", "Atomic Separation Facility").getStackForm(1)
        );
    }
    ...
    public void run() {
        ...
        ItemList.Hatch_Swarm_Conductivity_Sensor.set(
            new MTEHatchSwarmConductivitySensor(SwarmConductivitySensorHatch.ID, "hatch.swarm-conductivity-sensor", "Swarm Conductivity Sensor Hatch", 9).getStackForm(1)
        );
